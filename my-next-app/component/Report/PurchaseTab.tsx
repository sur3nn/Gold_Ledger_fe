...
export default function PurchaseTab({ fromDate, toDate }: PurchaseTabProps) {
  ...
  useEffect(() => {
    dispatch(getPurchaseReport({ fromDate, toDate }) as any);
  ...
  const COLS = ["Date", "Factory Source", "Weight", "Rate", "Total", "Ref", "Product Details"];
